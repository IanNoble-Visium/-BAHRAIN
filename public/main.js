...
function initializeContextGraph() {
    ...
    try {
        ...
        const cy = cytoscape({
            ...
            elements: [] // Start with empty elements, will add them next
        });
        ...
        console.log('🔍 DEBUG: Running layout...');
        ...
        // Store reference and fit after layout completes
        window.tcCytoscape = cy;

        // Fit the graph after layout animation completes
        setTimeout(() => {
            try {
                if (cy && typeof cy.fit === 'function') {
                    console.log('🔍 DEBUG: Calling cy.fit() with padding...');
